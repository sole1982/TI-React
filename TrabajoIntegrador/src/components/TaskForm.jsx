...
const TaskForm = () => {
  ...
  return (
    <div className="container w-100 mb-7">
      <form className="input-group shadow p-3 rounded w-100 " onSubmit={handleSubmit}>
        <input
        ...
        <button className=" form-control btn btn-info rounded" type="submit">
